...
public class BrowserUtils {
    ...
    public static String findNumberCharacter(String value){
    ...
    public static String findNumber(String value){
...
//        return Double.parseDouble(str[0]);
    ...
    public static double findNumberBigDecimal(String value){
